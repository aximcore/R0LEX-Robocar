...
//#endif
  ...
  std::vector<osmium::unsigned_object_id_type> hasDijkstraPath2 ( osmium::unsigned_object_id_type from, std::vector<Gangster> gangsters )
  {
    ...
    std::vector<osmium::unsigned_object_id_type> min_path;
    int min_dist {0};
